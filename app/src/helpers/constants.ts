...
export const MAX_BODY_PADDED_BYTES = 6464; // NOTE: this must be the same as the arg to sha the remainder number of bytes in the email in main args circom
...
export const STRING_PRESELECTOR = "<!-- actor name -->";
