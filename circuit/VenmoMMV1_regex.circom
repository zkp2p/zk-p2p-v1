...
template VenmoMMV1Regex (msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[2][i].in[0] <== and[29][i].out;
		multi_or[2][i].in[1] <== and[30][i].out;
		states[i+1][28] <== multi_or[2][i].out;
		eq[31][i] = IsEqual();
		eq[31][i].in[0] <== in[i];
		eq[31][i].in[1] <== 114;
		and[31][i] = AND();
		...
		eq[48][i].in[1] <== 110;
		and[48][i] = AND();
		and[48][i].a <== states[i][45];
		and[48][i].b <== eq[48][i].out;
		states[i+1][46] <== and[48][i].out;
		eq[49][i] = IsEqual();
		eq[49][i].in[0] <== in[i];
		eq[49][i].in[1] <== 109;
		and[49][i] = AND();
		and[49][i].a <== states[i][46];
		and[49][i].b <== eq[49][i].out;
		states[i+1][47] <== and[49][i].out;
		eq[50][i] = IsEqual();
		eq[50][i].in[0] <== in[i];
		eq[50][i].in[1] <== 111;
		and[50][i] = AND();
		and[50][i].a <== states[i][47];
		and[50][i].b <== eq[50][i].out;
		states[i+1][48] <== and[50][i].out;
		eq[51][i] = IsEqual();
		eq[51][i].in[0] <== in[i];
		eq[51][i].in[1] <== 46;
		and[51][i] = AND();
		...
		states[i+1][49] <== and[51][i].out;
		eq[52][i] = IsEqual();
		eq[52][i].in[0] <== in[i];
		eq[52][i].in[1] <== 99;
		and[52][i] = AND();
		and[52][i].a <== states[i][49];
		and[52][i].b <== eq[52][i].out;
		states[i+1][50] <== and[52][i].out;
		eq[53][i] = IsEqual();
		eq[53][i].in[0] <== in[i];
		eq[53][i].in[1] <== 111;
		and[53][i] = AND();
		and[53][i].a <== states[i][50];
		and[53][i].b <== eq[53][i].out;
		states[i+1][51] <== and[53][i].out;
		eq[54][i] = IsEqual();
		eq[54][i].in[0] <== in[i];
		eq[54][i].in[1] <== 109;
		and[54][i] = AND();
		and[54][i].a <== states[i][51];
		and[54][i].b <== eq[54][i].out;
		states[i+1][52] <== and[54][i].out;
	}
