...
contract Ramp is Verifier {
    ...
    uint16 private constant msgLen = 23;
        ...
        external
    {
        ...
        (uint256 offRamperVenmoId, uint256 amount, uint256 orderId, uint256 claimId) = _verifyAndParseOnRampProof(_a, _b, _c, _signals);
    ...
    function _verifyAndParseOnRampProof(
        ...
        internal
        view
        returns (uint256 offRamperVenmoId, uint256 usdAmount, uint256 orderId, uint256 claimId)
    {   
